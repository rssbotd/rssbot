...
from rssbot.brokers import objs
from rssbot.message import Message
from rssbot.objects import Object, construct, keys
from rssbot.threads import Repeater
...
DAY = 24*60*60
YEAR = 365*DAY
SOURCE = "https://github.com/bthate/rssbot"
...
def cbnow(_evt):
    ...
    txt += "https://pypi.org/project/rssbot"
